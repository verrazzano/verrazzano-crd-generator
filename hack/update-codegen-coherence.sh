...
GENERATED_ZZ_FILE=$SCRIPT_ROOT/pkg/apis/coherence/v1/zz_generated.deepcopy.go
echo Remove $GENERATED_ZZ_FILE file if exist
rm -f $GENERATED_ZZ_FILE

GENERATED_CLIENT_DIR=$SCRIPT_ROOT/pkg/clientcoherence
...
${CODEGEN_PKG}/generate-groups.sh "deepcopy,client,informer,lister" \
  github.com/verrazzano/verrazzano-crd-generator/pkg/clientcoherence github.com/verrazzano/verrazzano-crd-generator/pkg/apis \
  coherence:v1 \
