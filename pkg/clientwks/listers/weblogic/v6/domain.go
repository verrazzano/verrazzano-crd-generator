...
type DomainLister interface {
	...
	List(selector labels.Selector) (ret []*v6.Domain, err error)
...
// List lists all Domains in the indexer.
func (s *domainLister) List(selector labels.Selector) (ret []*v6.Domain, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v6.Domain))
	})
	return ret, err
}
...
type DomainNamespaceLister interface {
	...
	Get(name string) (*v6.Domain, error)
...
// List lists all Domains in the indexer for a given namespace.
func (s domainNamespaceLister) List(selector labels.Selector) (ret []*v6.Domain, err error) {
...
// Get retrieves the Domain from the indexer for a given namespace and name.
func (s domainNamespaceLister) Get(name string) (*v6.Domain, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v6.Resource("domain"), name)
	}
	return obj.(*v6.Domain), nil
}
