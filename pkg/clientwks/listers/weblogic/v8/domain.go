...
type DomainLister interface {
	...
	List(selector labels.Selector) (ret []*v8.Domain, err error)
...
// List lists all Domains in the indexer.
func (s *domainLister) List(selector labels.Selector) (ret []*v8.Domain, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v8.Domain))
	})
	return ret, err
}
...
type DomainNamespaceLister interface {
	...
	Get(name string) (*v8.Domain, error)
...
// List lists all Domains in the indexer for a given namespace.
func (s domainNamespaceLister) List(selector labels.Selector) (ret []*v8.Domain, err error) {
...
// Get retrieves the Domain from the indexer for a given namespace and name.
func (s domainNamespaceLister) Get(name string) (*v8.Domain, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v8.Resource("domain"), name)
	}
	return obj.(*v8.Domain), nil
}
