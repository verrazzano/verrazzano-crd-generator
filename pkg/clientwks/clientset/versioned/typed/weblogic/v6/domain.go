...
type DomainInterface interface {
	Create(*v6.Domain) (*v6.Domain, error)
	Update(*v6.Domain) (*v6.Domain, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v6.Domain, error)
	List(opts v1.ListOptions) (*v6.DomainList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v6.Domain, err error)
	DomainExpansion
}
...
func newDomains(c *WeblogicV6Client, namespace string) *domains {
	return &domains{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *domains) Get(name string, options v1.GetOptions) (result *v6.Domain, err error) {
	result = &v6.Domain{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("domains").
...
func (c *domains) List(opts v1.ListOptions) (result *v6.DomainList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v6.DomainList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("domains").
...
func (c *domains) Create(domain *v6.Domain) (result *v6.Domain, err error) {
	result = &v6.Domain{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("domains").
...
func (c *domains) Update(domain *v6.Domain) (result *v6.Domain, err error) {
	result = &v6.Domain{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("domains").
...
func (c *domains) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v6.Domain, err error) {
	result = &v6.Domain{}
