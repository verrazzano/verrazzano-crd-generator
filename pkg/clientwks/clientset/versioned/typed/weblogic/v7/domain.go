...
type DomainInterface interface {
	Create(ctx context.Context, domain *v7.Domain, opts v1.CreateOptions) (*v7.Domain, error)
	Update(ctx context.Context, domain *v7.Domain, opts v1.UpdateOptions) (*v7.Domain, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v7.Domain, error)
	List(ctx context.Context, opts v1.ListOptions) (*v7.DomainList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v7.Domain, err error)
	DomainExpansion
}
...
func newDomains(c *WeblogicV7Client, namespace string) *domains {
	return &domains{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *domains) Get(ctx context.Context, name string, options v1.GetOptions) (result *v7.Domain, err error) {
	result = &v7.Domain{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("domains").
...
func (c *domains) List(ctx context.Context, opts v1.ListOptions) (result *v7.DomainList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v7.DomainList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("domains").
...
func (c *domains) Create(ctx context.Context, domain *v7.Domain, opts v1.CreateOptions) (result *v7.Domain, err error) {
	result = &v7.Domain{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("domains").
...
func (c *domains) Update(ctx context.Context, domain *v7.Domain, opts v1.UpdateOptions) (result *v7.Domain, err error) {
	result = &v7.Domain{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("domains").
...
func (c *domains) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v7.Domain, err error) {
	result = &v7.Domain{}
