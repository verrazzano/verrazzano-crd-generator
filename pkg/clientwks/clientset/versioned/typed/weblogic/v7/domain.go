...
type DomainInterface interface {
	Create(*v7.Domain) (*v7.Domain, error)
	Update(*v7.Domain) (*v7.Domain, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v7.Domain, error)
	List(opts v1.ListOptions) (*v7.DomainList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v7.Domain, err error)
	DomainExpansion
}
...
func (c *domains) Get(name string, options v1.GetOptions) (result *v7.Domain, err error) {
	result = &v7.Domain{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("domains").
...
func (c *domains) List(opts v1.ListOptions) (result *v7.DomainList, err error) {
...
func (c *domains) Create(domain *v7.Domain) (result *v7.Domain, err error) {
	result = &v7.Domain{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("domains").
...
func (c *domains) Update(domain *v7.Domain) (result *v7.Domain, err error) {
	result = &v7.Domain{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("domains").
...
func (c *domains) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v7.Domain, err error) {
	result = &v7.Domain{}
