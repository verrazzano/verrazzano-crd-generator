...
func schema_pkg_apis_coherence_v1_ClusterRoleStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ClusterRoleStatus defines the observed state of role within the cluster",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"role": {
						SchemaProps: spec.SchemaProps{
					...
					"ready": {
						SchemaProps: spec.SchemaProps{
							Description: "A flag indicating the role's ready state",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
					...
					"conditions": {
						VendorExtensible: spec.VendorExtensible{
							Extensions: spec.Extensions{
								"x-kubernetes-list-map-keys": "status",
								"x-kubernetes-list-type":     "map",
							},
						},
						SchemaProps: spec.SchemaProps{
							Description: "The status transitions for the role",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_coherence_v1_ClusterRoleStatusCondition(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ClusterRoleStatusCondition defines a specific role status condition",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"status": {
						SchemaProps: spec.SchemaProps{
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"securityContext": {
						SchemaProps: spec.SchemaProps{
							Description: "SecurityContext is the PodSecurityContext that will be added to all of the Pods in this role. See: https://kubernetes.io/docs/tasks/configure-pod-container/security-context/",
					...
					"startQuorum": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "The roles that must be started before this role can start.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"roleStatus": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "The status of the roles in the cluster",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"startQuorum": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "The status of the start quorums for this role.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"excludeFromWKA": {
						SchemaProps: spec.SchemaProps{
							Description: "Exclude members of this role from being part of the cluster's WKA list.",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
...
func schema_pkg_apis_coherence_v1_NetworkSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "NetworkSpec configures various networking and DNS settings for Pods in a role.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"dnsConfig": {
						SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_coherence_v1_StartQuorum(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "StartQuorum defines the order that roles will be created when initially creating a new cluster.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"role": {
						SchemaProps: spec.SchemaProps{
							Description: "The list of roles to start first.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"podCount": {
						SchemaProps: spec.SchemaProps{
							Description: "The number of the dependency Pods that should have been started before this roles will be started.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
...
func schema_pkg_apis_coherence_v1_StartQuorumStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "StartQuorumStatus tracks the state of a role's start quorums.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"role": {
						SchemaProps: spec.SchemaProps{
					...
					"ready": {
						SchemaProps: spec.SchemaProps{
							Description: "Whether this quorum's condition has been met",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
