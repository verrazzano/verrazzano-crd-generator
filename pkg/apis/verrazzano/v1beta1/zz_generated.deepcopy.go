...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VerrazzanoConfigMap) DeepCopyInto(out *VerrazzanoConfigMap) {
	*out = *in
	if in.Labels != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VerrazzanoConfigMap.
func (in *VerrazzanoConfigMap) DeepCopy() *VerrazzanoConfigMap {
	if in == nil {
		return nil
	}
	out := new(VerrazzanoConfigMap)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VerrazzanoDeployment) DeepCopyInto(out *VerrazzanoDeployment) {
	*out = *in
	if in.Labels != nil {
		in, out := &in.Labels, &out.Labels
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VerrazzanoDeployment.
func (in *VerrazzanoDeployment) DeepCopy() *VerrazzanoDeployment {
	if in == nil {
		return nil
	}
	out := new(VerrazzanoDeployment)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VerrazzanoGenericComponent) DeepCopyInto(out *VerrazzanoGenericComponent) {
	*out = *in
	if in.Deployments != nil {
		...
		*out = make([]VerrazzanoDeployment, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.Services != nil {
		...
		*out = make([]VerrazzanoService, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ConfigMaps != nil {
		...
		*out = make([]VerrazzanoConfigMap, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VerrazzanoService) DeepCopyInto(out *VerrazzanoService) {
	*out = *in
	if in.Labels != nil {
		in, out := &in.Labels, &out.Labels
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VerrazzanoService.
func (in *VerrazzanoService) DeepCopy() *VerrazzanoService {
	if in == nil {
		return nil
	}
	out := new(VerrazzanoService)
	in.DeepCopyInto(out)
	return out
}
