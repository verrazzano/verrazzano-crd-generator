...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.AdminServer":     schema_pkg_apis_weblogic_v8_AdminServer(ref),
		"github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.AdminService":    schema_pkg_apis_weblogic_v8_AdminService(ref),
		"github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.Channel":         schema_pkg_apis_weblogic_v8_Channel(ref),
		"github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.Cluster":         schema_pkg_apis_weblogic_v8_Cluster(ref),
		"github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.Configuration":   schema_pkg_apis_weblogic_v8_Configuration(ref),
		"github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.Domain":          schema_pkg_apis_weblogic_v8_Domain(ref),
		"github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.DomainCondition": schema_pkg_apis_weblogic_v8_DomainCondition(ref),
		"github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.DomainSpec":      schema_pkg_apis_weblogic_v8_DomainSpec(ref),
		"github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.DomainStatus":    schema_pkg_apis_weblogic_v8_DomainStatus(ref),
		"github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.Istio":           schema_pkg_apis_weblogic_v8_Istio(ref),
		"github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.ProbeTuning":     schema_pkg_apis_weblogic_v8_ProbeTuning(ref),
		"github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.ServerHealth":    schema_pkg_apis_weblogic_v8_ServerHealth(ref),
		"github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.ServerPod":       schema_pkg_apis_weblogic_v8_ServerPod(ref),
		"github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.ServerService":   schema_pkg_apis_weblogic_v8_ServerService(ref),
		"github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.ServerStatus":    schema_pkg_apis_weblogic_v8_ServerStatus(ref),
		"github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.SubsystemHealth": schema_pkg_apis_weblogic_v8_SubsystemHealth(ref),
		"github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.WebLogicSecret":  schema_pkg_apis_weblogic_v8_WebLogicSecret(ref),
	}
}

func schema_pkg_apis_weblogic_v8_AdminServer(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					"serverPod": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.ServerPod"),
						},
					},
					"serverService": {
						SchemaProps: spec.SchemaProps{
							Description: "Customization affecting ClusterIP Kubernetes services for WebLogic Server instances.",
							Ref:         ref("github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.ServerService"),
						},
					},
					"serverStartState": {
						SchemaProps: spec.SchemaProps{
					...
					"adminService": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.AdminService"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.AdminService", "github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.ServerPod", "github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.ServerService"},
	}
}

func schema_pkg_apis_weblogic_v8_AdminService(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
					...
					"channels": {
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.Channel"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.Channel"},
	}
}

func schema_pkg_apis_weblogic_v8_Channel(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_pkg_apis_weblogic_v8_Cluster(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"clusterService": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.KubernetesResource"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.KubernetesResource", "github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.ServerPod", "github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.ServerService"},
	}
}

func schema_pkg_apis_weblogic_v8_Configuration(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"istio": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.Istio"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.Istio"},
	}
}

func schema_pkg_apis_weblogic_v8_Domain(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.DomainStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.DomainSpec", "github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.DomainStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_weblogic_v8_DomainCondition(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_weblogic_v8_DomainSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"webLogicCredentialsSecret": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.WebLogicSecret"),
						},
					},
					"logHome": {
						SchemaProps: spec.SchemaProps{
					...
					"adminServer": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.AdminServer"),
						},
					},
					"managedServers": {
						VendorExtensible: spec.VendorExtensible{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.ManagedServer"),
									},
								},
							},
						},
					...
					"clusters": {
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.Cluster"),
									},
								},
							},
						},
					...
					"configuration": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.Configuration"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.AdminServer", "github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.Cluster", "github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.Configuration", "github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.ManagedServer", "github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.ServerPod", "github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.ServerService", "github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.WebLogicSecret"},
	}
}

func schema_pkg_apis_weblogic_v8_DomainStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
					...
					"conditions": {
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.DomainCondition"),
									},
								},
							},
						},
					...
					"servers": {
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.ServerStatus"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.DomainCondition", "github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.ServerStatus"},
	}
}

func schema_pkg_apis_weblogic_v8_Istio(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Istio service mesh integration configuration",
...
func schema_pkg_apis_weblogic_v8_ProbeTuning(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_pkg_apis_weblogic_v8_ServerHealth(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
					...
					"subsystems": {
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.SubsystemHealth"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.SubsystemHealth"},
	}
}

func schema_pkg_apis_weblogic_v8_ServerPod(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"livenessProbe": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.ProbeTuning"),
						},
					},
					"readinessProbe": {
						SchemaProps: spec.SchemaProps{
					...
					"shutdown": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.Shutdown"),
						},
					},
					"volumes": {
						VendorExtensible: spec.VendorExtensible{
...
func schema_pkg_apis_weblogic_v8_ServerStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Status of WebLogic servers in this domain",
				...
				Properties: map[string]spec.Schema{
					...
					"health": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.ServerHealth"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/verrazzano/verrazzano-crd-generator/pkg/apis/weblogic/v8.ServerHealth"},
	}
}

func schema_pkg_apis_weblogic_v8_SubsystemHealth(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_weblogic_v8_WebLogicSecret(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
