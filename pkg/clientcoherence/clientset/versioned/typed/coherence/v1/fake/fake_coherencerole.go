...
func (c *FakeCoherenceRoles) Get(name string, options v1.GetOptions) (result *coherencev1.CoherenceRole, err error) {
	obj, err := c.Fake.
...
func (c *FakeCoherenceRoles) List(opts v1.ListOptions) (result *coherencev1.CoherenceRoleList, err error) {
	obj, err := c.Fake.
...
func (c *FakeCoherenceRoles) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeCoherenceRoles) Create(coherenceRole *coherencev1.CoherenceRole) (result *coherencev1.CoherenceRole, err error) {
	obj, err := c.Fake.
...
func (c *FakeCoherenceRoles) Update(coherenceRole *coherencev1.CoherenceRole) (result *coherencev1.CoherenceRole, err error) {
	obj, err := c.Fake.
...
func (c *FakeCoherenceRoles) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeCoherenceRoles) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(coherencerolesResource, c.ns, listOptions)
...
func (c *FakeCoherenceRoles) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *coherencev1.CoherenceRole, err error) {
	obj, err := c.Fake.
