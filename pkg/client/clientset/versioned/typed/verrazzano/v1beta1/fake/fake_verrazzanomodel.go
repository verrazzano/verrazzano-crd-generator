...
func (c *FakeVerrazzanoModels) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.VerrazzanoModel, err error) {
	obj, err := c.Fake.
...
func (c *FakeVerrazzanoModels) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.VerrazzanoModelList, err error) {
	obj, err := c.Fake.
...
func (c *FakeVerrazzanoModels) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeVerrazzanoModels) Create(ctx context.Context, verrazzanoModel *v1beta1.VerrazzanoModel, opts v1.CreateOptions) (result *v1beta1.VerrazzanoModel, err error) {
	obj, err := c.Fake.
...
func (c *FakeVerrazzanoModels) Update(ctx context.Context, verrazzanoModel *v1beta1.VerrazzanoModel, opts v1.UpdateOptions) (result *v1beta1.VerrazzanoModel, err error) {
	obj, err := c.Fake.
...
func (c *FakeVerrazzanoModels) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeVerrazzanoModels) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(verrazzanomodelsResource, c.ns, listOpts)
...
func (c *FakeVerrazzanoModels) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.VerrazzanoModel, err error) {
	obj, err := c.Fake.
